...
import org.tesuri.android.ime.skk.dlog
import org.tesuri.android.ime.skk.isAlphabet
import org.tesuri.android.ime.skk.processConcatAndEscape
import org.tesuri.android.ime.skk.removeAnnotation
import org.tesuri.android.ime.skk.SKKDictionary
import org.tesuri.android.ime.skk.SKKPrefs
import org.tesuri.android.ime.skk.SKKService
import org.tesuri.android.ime.skk.SKKUserDictionary
    ...
    fun changeLastChar(type: String) {
        when {
            state === SKKKanjiState && mComposing.isEmpty() -> {
                ...
                val idx = s.length - 1
                val newLastChar = RomajiConverter.convertLastChar(s.substring(idx), type)
                        ?: return
            ...
            state === SKKNarrowingState && mComposing.isEmpty() -> {
                ...
                val newLastChar = RomajiConverter.convertLastChar(hint.substring(idx), type)
                        ?: return
            ...
            state === SKKChooseState -> {
                ...
                val newOkuri = RomajiConverter.convertLastChar(okuri, type)
                        ?: return
            ...
            mComposing.isEmpty() && mKanjiKey.isEmpty() -> {
                ...
                val newLastChar = RomajiConverter.convertLastChar(cs.toString(), type)
                        ?: return
