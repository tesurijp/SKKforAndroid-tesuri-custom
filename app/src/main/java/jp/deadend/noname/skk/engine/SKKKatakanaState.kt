...
object SKKKatakanaState : SKKState {
    ...
    override val icon = if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) R.drawable.ic_katakana else R.drawable.immodeic_katakana
    ...
    override fun afterBackspace(context: SKKEngine) = SKKHiraganaState.afterBackspace(context)
    override fun handleCancel(context: SKKEngine) = SKKHiraganaState.handleCancel(context)
}
